...
public class WSWorldNews extends base{
	...
	public static void wna() throws InterruptedException, IOException {
		...
		String WorldHeaderLink = driver.findElement(By.xpath("//main[@id='main']/div[1]/div[1]/div[1]/div[2]/div/h2/a"))
				.getAttribute("href");
		...
		//Log.info("Total WORLD NEWS articles link Count: "+CountWorldNews);
		// Enhanced for loop
		for (WebElement option : WorldNewsArticles) {
			...
			//Log.info("World News Links: " + allWorldArticleLinks);
